...
def new_password():
    ...
    rank0 = shared_data[2]
    ranks, password, quote_release, with_quote, symbols_list, symbols_str, lucky_list, lucky_str = pass_generator.main(rank0, password, quote, release, lucky_number, username)
    response = {"ranks": ranks, "password": password, "quote_release":quote_release, "with_quote":with_quote,
                "symbols_list":symbols_list, "symbols_str": symbols_str, "lucky_list": lucky_list, "lucky_str": lucky_str}
    return jsonify(response)
